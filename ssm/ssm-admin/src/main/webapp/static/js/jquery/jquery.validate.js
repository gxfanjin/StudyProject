...
(function(factory) {
	if (typeof define === "function" && define.amd) {
		...
		(function($) {
			...
			$
					.extend(
							$.fn,
							{
								...
								// attributes: space separated list of
								// attributes to retrieve and remove
							...
							$.validator,
							{
								...
								prototype : {
									...
									init : function() {
										...
										function delegate(event) {
											var validator = $.data(
													this[0].form, "validator"), eventType = "on"
													+ event.type.replace(
								...
								attributeRules : function(element) {
									...
									for (method in $.validator.methods) {
										...
										// convert the value to a number for
										// number inputs, and for text for
			...
			// scope of the jquery-object for event.target
			...
			jQuery.validator.addMethod("isContainsNull", function(value, element) {
				return this.optional(element)
						|| value.indexOf(" ") == -1;
			}, "请正确的用户名");
			
			jQuery.validator.addMethod("AllIsShuzi", function(value, element) {
